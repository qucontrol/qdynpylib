...
class State(object):
    ...
    def write(self, filename):
        ...
        with open(filename, 'w') as out_fh:
            is_complex = np.any(np.iscomplex(self.psi))
            if is_complex:
    ...
    @classmethod
    def read(cls, filename, n):
        """Read the wave function of size `n` from file. Inverse to `write`."""
